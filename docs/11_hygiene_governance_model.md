...
Wiki Link, `formalizes`, `realizes`, and `projects` inputs now normalize into
this model without changing their public syntax or diagnostic contracts. The
...
SPEC-003 defines the profile evaluation and migration contract. Atomic invariant
