...
[FEATURE-011](../zh/issues/features/11_execution-and-migration.md).
...
[Document Kind Registry](../capabilities/document-kinds.md).
...
derived separately through [Progressive Rule Activation](progressive-rule-activation.md),
...
[PRD-004](../engineering/prd/prd-004/index.md) defines a separate three-level maturity
