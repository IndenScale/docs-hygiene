...
configured document profiles, governed UL/PRD packages, explicit topology
...
| `governance.traceability` | critical Pins and portable evidence |
...
Model](hygiene-governance-model.md) applies basic, controlled, or governed
