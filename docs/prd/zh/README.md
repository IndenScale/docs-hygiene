...
PRD 是 Intent Layer 的 Body，并引用作为同层 Reference Library 的 UL。PRD 中的
主张必须继续形式化为 Definition Layer 的 Spec，而不能直接跳到实现或 Evidence。
...
- [PRD-001 三层契约治理](01_intent_contract_governance.md)
