...
绑定、规范化治理图及拓扑指标、责任/复核/知识覆盖与逐身份 bus factor、各维度目标与
检测结果、N/A 理由、不变量证据、可选总体
...
、权威迁移、关键 Pin 策略、可移植离线 commit snapshot、审计拓扑预算、supernode
exception、度数趋势、责任覆盖、复核日落和知识冗余已经交付；已应用例外按设计保持
`excepted`，不构成 Passed 证据。
权威覆盖账本见
[FEATURE-009](../issues/features/09_atomic-invariants.md)。
