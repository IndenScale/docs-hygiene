...
The built-in relation is `references`, independent of whether the normalized
edge currently has a Pin. Adapter-specific Issue relations are governed by that
adapter's contract. Paths are project-relative
