...
governance:
  ...
  coreClaims:
    - id: retry-policy
      ...
      occurrences:
        - path: docs/engineering/prd/prd-001/requirements/retries.md
          selector: copied-contract
          policy: forbidden
        - path: docs/engineering/prd/prd-002/migration.md
          selector: legacy-contract
          policy: migrate
          migrateBy: 2026-09-30
        - path: docs/engineering/prd/prd-003/summary.md
